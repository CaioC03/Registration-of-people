...
class App(ctk.CTk):
    ...
    def layout_config(self):
        self.title("Sitema de Gestão de Pessoas")
    ...
    def todo_sistema(self):
        ...
        title = ctk.CTkLabel(frame, text="Sistema de Cadastro de Pessoas", font=("Century Gothic bold", 24), text_color="#fff").place(x=190, y=10)
        ...
        ficha = pathlib.Path("Pessoas.xlsx")
        ...
        def submit():
            ...
            if (nome =="" or contato=="" or idade=="" or endereco==""):
                ...
                ficha = openpyxl.load_workbook('Pessoas.xlsx')
                folha = ficha.active
